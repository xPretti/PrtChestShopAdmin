                ...
                if(amount != null & args.length > 1)
                  {
                    ...
                    if(buyPrice != null)
                      {
                        pricingManager.addPricingDetails(player.getUniqueId(), new PricingDetails(amount, buyPrice, sellPrice));
                        String[] message = {
                                "",
                                "§6§lMC §6» §aVocê iniciou o modo de configuração de lojas!",
                                String.format("§6§lMC §6» §7Quantidade: §b%s §7| Preço compra: §a%s§7 | Preço venda: §c%s", amount, buyPrice, sellPrice == null ? "0" : sellPrice),
